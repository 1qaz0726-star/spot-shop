    ...
    <div ref={rootRef} className={cn("relative w-full", className)}>
      <form
        ...
        className={cn(
          ...
          panelOpen && "border-[var(--color-brand)] ring-2 ring-orange-500/20 shadow-md"
        )}
      >
        ...
        <button
          ...
          className={cn(
            ...
            isHeader
              ? "border-orange-600 bg-[var(--color-brand)] px-5 text-sm hover:bg-[var(--color-brand-dark)]"
              : "border-orange-600 bg-[var(--color-brand)] px-4 text-xs hover:bg-[var(--color-brand-dark)]"
          )}
        >
          搜尋
        </button>
